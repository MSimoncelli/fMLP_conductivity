...
def command_return(i):
    ...
    command=[r'mace_run_train  ',
            ...
            r'  --model="MACE" ',
            r'  --train_file="dataset_train_20_frame.xyz" ',  #dataset containing configurations for a material, e.g. LiBr
            r'  --valid_file="dataset_valid_20_frame.xyz" ',  #dataset containing configurations for a material, e.g. LiBr
            r'  --energy_weight=1.0 ',
            ...
            r'  --E0s="{3: -3.482100566595956, 35: -2.5184940099633986}" ', #E0s for Li and Br
            r'  --loss="universal" ',
